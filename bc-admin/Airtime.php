...
ini_set("display_errors", 1); session_start();
    ...
    if(isset($_POST["install-product"])){
        ...
        install_product($connection_server, $get_logged_admin_details, "airtime", "sas_airtime_status", $products_array);
    }
                    ...
                    <tbody>
                        <?php
                            ...
                            foreach($item_name_array_2 as $products){
                                $get_item_status_details = mysqli_query_and_fetch_array($connection_server, "SELECT * FROM sas_airtime_status WHERE vendor_id='".$get_logged_admin_details["id"]."' && product_name='$products'");
