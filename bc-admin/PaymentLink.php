            ...
            <form method="post" action="">
                <?php
                    foreach($payment_link_gateway_array as $gateway_name){
                        $get_gateway_details = mysqli_query_and_fetch_array($connection_server, "SELECT * FROM sas_payment_link_gateways WHERE vendor_id='".$get_logged_admin_details["id"]."' && gateway_name='$gateway_name'");
