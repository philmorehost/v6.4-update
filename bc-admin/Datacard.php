                    ...
                    <tbody>
                        ...
                        <?php
                            ...
                            foreach($item_name_array_2 as $products){
                                $get_item_status_details = mysqli_query_and_fetch_array($connection_server, "SELECT * FROM sas_datacard_status WHERE vendor_id='".$get_logged_admin_details["id"]."' && product_name='$products'");
                        ...
                        foreach($item_name_array_3 as $products){
                            ...
                            if($count_product_variety >= 1){
                                foreach($product_variety as $product_qty){
                                    ...
                                    $get_datacard_product_cards = mysqli_query_and_fetch_array($connection_server, "SELECT * FROM sas_cards WHERE vendor_id='".$get_logged_admin_details["id"]."' && card_name='".$textarea_id_name."' LIMIT 1");
