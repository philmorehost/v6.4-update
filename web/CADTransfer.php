...
<head>
    <title>Interac e-Transfer | <?php echo $get_all_site_details["site_title"]; ?></title>
    <meta charset="UTF-8" />
    ...
    <section class="section dashboard">
        <div class="col-12">
            <div class="card info-card px-5 py-5">
                ...
                <a href="CadETransferBeneficiary.php">Create e-Transfer Beneficiary</a>
            </div>
        </div>
    </section>
