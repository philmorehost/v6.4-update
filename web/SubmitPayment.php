      ...
      <div class="col-12">
        ...
        <div style="text-align: center;" class="card info-card px-5 py-5">
            ...
            <form method="post" action="">
                ...
                <input style="text-align: center;" name="amount" onkeyup="submitPayment(this);" type="text" inputmode="numeric" pattern="[0-9]*" title="Digit must be around 2 digit upward naira" value="" placeholder="Amount" class="form-control my-2" required/>
