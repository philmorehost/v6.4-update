    ...
    if ($product_name == "startimes") {
        ...
        if ($product_name == "dstv") {
            ...
            if ($product_name == "gotv") {
                ...
                if ($product_name == "showmax") {
                    $web_cable_size_array = array(
                        "full" => "full",
                        "mobile_only" => "mobile_only",
                        "sports_mobile_only" => "sports_mobile_only",
                        "full_sports_mobile_only" => "full_sports_mobile_only",
                        "full_3months" => "full_3months",
                        "mobile_only_3months" => "mobile_only_3months",
                        "sports_mobile_only_3months" => "sports_mobile_only_3months",
                        "full_sports_mobile_only_3months" => "full_sports_mobile_only_3months",
                        "mobile_only_6months" => "mobile_only_6months",
                        "full_6months" => "full_6months",
                        "full_sports_mobile_only_6months" => "full_sports_mobile_only_6months",
                        "sports_mobile_only_6months" => "sports_mobile_only_6months",
                        "sports_only" => "sports_only",
                        "sports_only_3months" => "sports_only_3months",
                        "sports_only_6months" => "sports_only_6months"
                    );
                }
            }
        }
