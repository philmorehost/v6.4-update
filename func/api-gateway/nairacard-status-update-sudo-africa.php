...
$curl_url = "https://api.sandbox.sudo.cards/cards/".$virtual_card_detail["card_id"];
...
$curl_postfields_data = json_encode(array("status" => $card_status_array[$card_status]), true);
...
fwrite(fopen("nairacard-status.txt", "a++"), $curl_postfields_data . "\n" . $curl_result . "\n\n\n");
