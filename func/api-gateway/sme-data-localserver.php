<?php
    ...
    if(in_array($product_name, array_keys($data_service_provider_alter_code))){
        ...
        if(in_array($quantity, array_keys($web_data_size_array))){
            ...
            $curl_postfields_data = json_encode(array("api_key"=> $api_detail["api_key"],"network"=> $product_name,"phone_number"=> $phone_no,"type"=> "sme-data", "quantity"=>$web_data_size_array[$quantity]), true);
