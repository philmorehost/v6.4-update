<?php
// Reloadly International Airtime Gateway

// 1. Get Access Token
$client_id = $api_detail["encrypt_key"]; // Using encrypt_key for client_id
$client_secret = $api_detail["api_key"]; // Using api_key for client_secret
...
if (isset($auth_json["access_token"])) {
    ...
    // 2. Make Top-up Request
    $topup_url = "https://topups.reloadly.com/topups";
    $topup_data = [
        "operatorId" => $operator_id,
        "amount" => $amount, // This should be in the destination currency or handled by Reloadly
    ...
    if ($http_code == 200 || $http_code == 201) {
        ...
        $api_response_description = "International Airtime Successful. Ref: " . $topup_json["transactionId"];
