...
if (json_last_error() === JSON_ERROR_NONE) {
    ...
    if (
                                ...
                                if (mysqli_num_rows($select_product_apis) == 1) {
                                    ...
                                    if (mysqli_num_rows($select_installed_product_apis) == 1) {
                                        ...
                                        if ($api_file_exists) {
                                            ...
                                            $product_qty = "1";
                                            $product_id = $iuc_number;
                                            $amount_1 = $product_price + $product_profit;
                                            $profit = $product_profit;
                                            $description = "Transaction Pending | " . str_replace(["_", "-"], " ", $cable_qty) . " to IUC No: " . $iuc_number . " was pending";
                                            ...
                                            if ($debit_user === true) {
                                                ...
                                                if ($api_response_status == 1) {
                                                    ...
                                                    $product_qty_2 = "1";
                                                    $product_id_2 = $iuc_number . " " . $tx_ref;
                                                    $amount_2 = get_transaction($username, $tx_ref, "amount");
                                                    $profit_2 = "";
                                                    $description_2 = "Cable Refund";
        ...
        if (empty($username)) {
            ...
            $status_msg = "Cable Size is required";
