...
if (json_last_error() === JSON_ERROR_NONE) {
    ...
    if (
                                ...
                                if (mysqli_num_rows($select_product_apis) == 1) {
                                    ...
                                    if (mysqli_num_rows($select_installed_product_apis) == 1) {
                                        ...
                                        if ($api_file_exists) {
                                            ...
                                            $description = "Transaction Pending | " . str_replace(["_", "-"], " ", $education_qty) . " qty of " . $network . " was pending";
                                            ...
                                            if ($debit_user === true) {
                                                ...
                                                if ($api_response_status == 1) {
                                                    ...
                                                    $education_token = $api_response_token;
                                                    $education_token_unit = $api_response_token_unit;
                                                    ...
                                                    $profit_2 = "";
                                                    $description_2 = "Education Refund";
        ...
        if (empty($username)) {
            ...
            $status_msg = "Education Size is required";
        }
    }
